        ...
        <div class="language-selector dropdown js-dropdown">
            <button data-toggle="dropdown" class="hidden-sm-down btn-unstyle" aria-haspopup="true" aria-expanded="false"
                ...
                <span class="expand-more">
                    {foreach from=$languages item=language}{if $language.id_lang == $current_language.id_lang}<i
                        style="background-image: url('/themes/cadouri/assets/img/langs.jpg')"
                        class="lang-flag lang-{$language.iso_code}"></i> {$language.iso_code}{/if}{/foreach}</span>
                ...
                {foreach from=$languages item=language}
                    <li {if $language.id_lang == $current_language.id_lang} class="current" {/if}>
                        <a href="{url entity='language' id=$language.id_lang}" class="dropdown-item"
                           data-iso-code="{$language.iso_code}"><i
                                    style="background-image: url('/themes/cadouri/assets/img/langs.jpg')"
                                    class="lang-flag lang-{$language.iso_code}"></i> {$language.iso_code}</a>
                    </li>
                {/foreach}
            </ul>
